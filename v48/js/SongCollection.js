    ...
    render() {
        ...
        setTimeout(() => {
            ...
            this.songs.forEach((song, index) => {
                ...
                // Klassen für das Layout und die Positionierung des Hintergrunds
                ...
                card.innerHTML = `
                    <div class="absolute inset-0 z-0 opacity-20 group-hover:opacity-40 group-hover:scale-110 transition-all duration-700 bg-cover bg-center" 
                        style="background-image: url('${artworkUrl}'); filter: grayscale(20%);">
                    </div>
                ...
                // Falls das Bild nicht existiert, den Background-Layer dezent halten oder entfernen
