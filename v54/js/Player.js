...
class NeuralPlayer {
    ...
    */
    ...
    async updateMediaSession(song) {
        if ('mediaSession' in navigator) {this.updatePlaybackPosition();
    ...
    async downloadCurrentTrack() {
        ...
        try {
            this.playerStatus.textContent = "Initiating Download...";
            ...
            a.href = url;
            // Sets the filename as "Song Title.mp3"
            ...
            this.playerStatus.textContent = "Neural Fusion Active";
        } catch (err) {
            console.error("Download failed:", err);
            this.playerStatus.textContent = "Download Failed";
        }
    }    
}   