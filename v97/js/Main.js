...
async function loadAndDisplayFeatureSongs() {
    try {
        ...
        const featureData1 = await songService.getById('surfing_girl_wild_and_free');
        const featureData2 = await songService.getById('southern_belle');
        const featureData3 = await songService.getById('delta_blues');
        const featureData4 = await songService.getById('southerns_eve');
        const featureData5 = await songService.getById('southern_heat');
        const featureData6 = await songService.getById('black_cat_bones');
        const featureData7 = await songService.getById('fire_in_my_veins');
        
        // Combine them into one array for the collection update
        const featureData = [...featureData1, ...featureData2, ...featureData3, ...featureData4, ...featureData5, ...featureData6, ...featureData7];
